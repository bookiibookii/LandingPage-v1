...
const DEMO_FLOWS: Record<number, DemoScreen[]> = {
  0: [
    { label: "로그인", src: "/assets/onboarding-1.png" },
    ...
    { label: "한 줄 소개 입력", src: "/assets/onboarding-5.png" },
  ],
  1: [
    { label: "추천 피드 탐색", src: "/assets/hom-1.png" },
    { label: "그룹 검색", src: "/assets/hom-2.png" },
    { label: "그룹 상세", src: "/assets/hom-3.png" },
    { label: "그룹 생성", src: "/assets/hom-4.png" },
    { label: "키워드 알림", src: "/assets/hom-5.png" },
  ],
  2: [
    { label: "트래커 메인", src: "/assets/trk-1.png" },
    { label: "교환 진행", src: "/assets/trk-2.png" },
    { label: "1:1 메시지", src: "/assets/trk-3.png" },
    { label: "진행률 기록", src: "/assets/trk-4.png" },
    { label: "후기 작성", src: "/assets/trk-5.png" },
  ],
  3: [
    { label: "서재 메인", src: "/assets/lib-1.png" },
    { label: "북마크함", src: "/assets/lib-2.png" },
    { label: "독서카드", src: "/assets/lib-3.png" },
    { label: "독서카드 공유", src: "/assets/lib-4.png" },
  ],
  4: [
    { label: "마이페이지", src: "/assets/myp-1.png" },
    { label: "프로필 공유", src: "/assets/myp-2.png" },
    { label: "나의 책장", src: "/assets/myp-3.png" },
    { label: "인생 책 등록", src: "/assets/myp-4.png" },
  ],
};
